...
public class SpawnOpposite : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        timeBetween = 1.0f/spawnRatePerSecond;
    }
    ...
    void makeObstacle(){
        ...
        xPos = Random.Range(-1, 2) * 3 + (int)gameObject.transform.position.x;
    ...
    void makeObstacle(int excludedLane){
        xPos2 = Random.Range(-1, 2) * 3 + (int)gameObject.transform.position.x;
